...
from tools.vproto import VirtmcuHandshake, MmioReq, VIRTMCU_PROTO_MAGIC, VIRTMCU_PROTO_VERSION, MMIO_REQ_WRITE
...
def test_start_server_success(mock_exists, mock_unlink, mock_socket_cls, capsys):
    ...
    valid_req = MmioReq(type=MMIO_REQ_WRITE, size=4, reserved1=0, reserved2=0, vtime_ns=1000, addr=0x1000, data=0xABCD).pack()
