...
TMPDIR_LOCAL="$(mktemp -d /tmp/clock_suspend_stall_XXXXXX)"
QEMU_PID=""
ROUTER_PID=""
...
python3 -u "$WORKSPACE_DIR/tests/fixtures/guest_apps/clock_suspend/clock_stall_test.py" "$ENDPOINT" &
PYTHON_PID=$!
sleep 1
